...
@section('css')
    <!-- alertifyjs Css -->
    <link href="{{ URL::asset('vendors/libs/alertifyjs/build/css/alertify.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- alertifyjs default themes  Css -->
    <link href="{{ URL::asset('vendors/libs/alertifyjs/build/css/themes/default.min.css') }}" rel="stylesheet"
        type="text/css" />
@endsection
@section('page-title')
    Notifications
...
@section('body')
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="toast fade show" role="alert" aria-live="assertive"
                                        ...
                                        <div class="toast-header">
                                            <img src="{{ URL::asset('vendors/images/logo-dark-sm.png') }}" alt=""
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="bg-soft-light p-3">
                                        <div class="toast fade show" role="alert" aria-live="assertive"
                                            data-bs-autohide="false" aria-atomic="true">
                                            <div class="toast-header">
                                                <img src="{{ URL::asset('vendors/images/logo-dark-sm.png') }}"
                                                    alt="" class="me-2" height="18">
                                                <strong class="me-auto">webadmin</strong>
                                                <small class="text-muted">11 mins ago</small>
                                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                                    aria-label="Close"></button>
    ...
    @section('scripts')
        <!-- alertifyjs js -->
        <script src="{{ URL::asset('vendors/libs/alertifyjs/build/alertify.min.js') }}"></script>
        <!-- notification init -->
        <script src="{{ URL::asset('vendors/js/pages/notification.init.js') }}"></script>
        <!-- App js -->
