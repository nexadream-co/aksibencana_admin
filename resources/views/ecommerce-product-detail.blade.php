...
@section('css')
    <!-- swiper css -->
    <link rel="stylesheet" href="{{ URL::asset('vendors/libs/swiper/swiper-bundle.min.css') }}">
@endsection
@section('page-title')
    Product Detail
@endsection
@section('body')
                                    ...
                                    <div
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide rounded">
                                                <div class="p-3">
                                                    <div class="product-img bg-light rounded p-3">
                                                        <img src="{{ URL::asset('vendors/images/product/img-2.png') }}"
                                                            class="img-fluid d-block" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide rounded">
                                                <div class="p-3">
                                                    <div class="product-img bg-light rounded p-3">
                                                        <img src="{{ URL::asset('vendors/images/product/img-6.png') }}"
                                                            class="img-fluid d-block" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide rounded">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('vendors/images/product/img-1.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('vendors/images/product/img-2.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('vendors/images/product/img-3.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('vendors/images/product/img-6.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('vendors/images/product/img-5.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="desc" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-3 col-md-3">
                                                    <div>
                                                        <img src="{{ URL::asset('vendors/images/product/img.png') }}"
    ...
    @section('scripts')
        <!-- swiper js -->
        <script src="{{ URL::asset('vendors/libs/swiper/swiper-bundle.min.js') }}"></script>

        <script src="{{ URL::asset('vendors/js/pages/ecommerce-product-detail.init.js') }}"></script>
        <!-- App js -->
