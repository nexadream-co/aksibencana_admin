        ...
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img class="rounded me-2" alt="200x200" width="200"
                                    src="{{ URL::asset('vendors/images/small/img-4.jpg') }}" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img class="img-thumbnail" alt="200x200" width="200"
                                    src="{{ URL::asset('vendors/images/small/img-3.jpg') }}" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-md-6">
                                <div class="mt-4 mt-md-0">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            <img src="{{ URL::asset('vendors/images/small/img-2.jpg') }}" class="img-fluid"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <img src="{{ URL::asset('vendors/images/users/avatar-4.jpg') }}" alt=""
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <img src="{{ URL::asset('vendors/images/users/avatar-5.jpg') }}" alt=""
