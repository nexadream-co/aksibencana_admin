...
@section('body')
    ...
    @section('scripts')
        <!-- ckeditor -->
        <script src="{{ URL::asset('vendors/libs/@ckeditor/ckeditor5-build-classic/build/ckeditor.js') }}"></script>

        <!-- email editor init -->
        <script src="{{ URL::asset('vendors/js/pages/email-editor.init.js') }}"></script>
        <!-- App js -->
