                ...
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                    <div>
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link" href="contacts-list" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <img src="{{ URL::asset('vendors/images/users/avatar-2.jpg') }}" alt=""
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <img src="{{ URL::asset('vendors/images/users/avatar-1.jpg') }}" alt=""
                                    class="avatar-md rounded-circle img-thumbnail">
                            </div>
                            <div class="flex-1 ms-3">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <img src="{{ URL::asset('vendors/images/users/avatar-8.jpg') }}" alt=""
                                    class="avatar-md rounded-circle img-thumbnail">
                            </div>
                            <div class="flex-1 ms-3">
