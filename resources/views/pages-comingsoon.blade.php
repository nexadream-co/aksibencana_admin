...
@section('body')
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <a href="index" class="d-block auth-logo">
                                <img src="{{ URL::asset('vendors/images/logo-dark.png') }}" alt="" height="36"
                                    class="auth-logo-dark mx-auto">
                                <img src="{{ URL::asset('vendors/images/logo-light.png') }}" alt="" height="36"
                                    class="auth-logo-light mx-auto">
                            </a>
                            <div class="row justify-content-center mt-5">
                                <div class="col-sm-6">
                                    <div class="maintenance-img">
                                        <img src="{{ URL::asset('vendors/images/coming-soon.png') }}" alt=""
    ...
    @section('scripts')
        <!-- Countdown js -->
        <script src="{{ URL::asset('vendors/js/pages/coming-soon.init.js') }}"></script>
        <!-- App js -->
