                            ...
                            <div class="my-auto py-5">
                                <div class="text-center mb-4 pb-1">
                                    <a href="index" class="d-block auth-logo">
                                        <img src="{{ URL::asset('vendors/images/logo-dark.png') }}" alt=""
                                            height="36" class="auth-logo-dark">
                                        <img src="{{ URL::asset('vendors/images/logo-light.png') }}" alt=""
                                            height="36" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-5">
                                        <div class="mt-4">
                                            <img src="{{ URL::asset('vendors/images/maintenance.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
