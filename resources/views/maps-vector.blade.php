...
@section('body')
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('vendors/libs/jsvectormap/maps/us-merc-en.js') }}"></script>
        <script src="{{ URL::asset('vendors/libs/jsvectormap/maps/canada.js') }}"></script>

        <!-- vector-maps init -->
        <script src="{{ URL::asset('vendors/js/pages/vector-maps.init.js') }}"></script>
        <!-- App js -->
