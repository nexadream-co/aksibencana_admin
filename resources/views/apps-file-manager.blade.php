...
@section('css')
    <!-- dropzone css -->
    <link href="{{ URL::asset('vendors/libs/dropzone/min/dropzone.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    File Manager
@endsection
@section('body')
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="mt-4 pt-3 mt-auto text-center">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="px-4">
                                                <img src="{{ URL::asset('vendors/images/Upgrade-img.png') }}"
                                                    class="img-fluid" alt="">
                                            </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="d-flex align-items-center overflow-hidden">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <a href=""
                                                                class="font-size-14 text-muted text-truncate"><u>View
                                                                    Folder</u></a>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3 pt-1">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="text-muted font-size-13 mb-1 text-truncate">25GB used
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="d-flex align-items-center overflow-hidden">
                                                        ...
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar align-self-center">
                                                                <div
                                                                    class="avatar-title rounded bg-soft-info text-info font-size-24">
                                                    ...
                                                    <div class="mt-3 pt-1">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="text-muted font-size-13 mb-1 text-truncate">50GB used
                                                            </p>
                                                        </div>
                                                        <div class="progress animated-progess custom-progress">
                                                            <div class="progress-bar bg-gradient bg-primary"
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="mt-3 pt-1">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="text-muted font-size-13 mb-1 text-truncate">20GB used
                                                            </p>
                                                        </div>
                                                        <div class="progress animated-progess custom-progress">
                                                            <div class="progress-bar bg-gradient bg-primary"
                                                        ...
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-4.jpg') }}"
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        ...
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 15 min
                                                                ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-3.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-6.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        ...
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 23 min
                                                                ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="avatar-group">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-2.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        ...
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 45 min
                                                                ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <div class="overflow-hidden me-auto">
                                                            <h5 class="font-size-15 text-truncate mb-1"><a
                                                                    href="javascript: void(0);"
                                                                    class="text-body">Photoshop</a></h5>
                                                            <p class="text-muted text-truncate mb-0">366 Files</p>
                                                        </div>
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 5 hrs
                                                                ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-8.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <div class="overflow-hidden me-auto">
                                                            <h5 class="font-size-15 text-truncate mb-1"><a
                                                                    href="javascript: void(0);" class="text-body">Laravel
                                                                    Design</a></h5>
                                                            <p class="text-muted text-truncate mb-0">185 Files</p>
                                                        </div>
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 23 min
                                                ...
                                                <div class="">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="avatar-group">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-5.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <div class="overflow-hidden me-auto">
                                                            <h5 class="font-size-15 text-truncate mb-1"><a
                                                                    href="javascript: void(0);"
                                                                    class="text-body">Ecommerce</a></h5>
                                                            <p class="text-muted text-truncate mb-0">56 Files</p>
                                                        </div>
                                                        <div class="align-self-end ms-2">
                                                            <p class="text-muted mb-0 font-size-13"><i
                                                                    class="bx bx-time-five align-middle me-1"></i> 8 hrs
                                                                ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-nowrap table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="mdi mdi-folder-zip font-size-20 align-middle text-warning me-2"></i>
                                                            Project-A.zip</a></td>
                                                    <td>11-10-2021</td>
                                                    <td>115 KB</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="mdi mdi-image font-size-20 align-middle text-muted me-2"></i>
                                                            Img-1.jpeg</a></td>
                                                    <td>11-10-2021</td>
                                                    <td>86 KB</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="mdi mdi-text-box font-size-20 align-middle text-muted me-2"></i>
                                                    ...
                                                    <td>
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-1.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('vendors/images/users/avatar-7.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="mdi mdi-folder font-size-20 align-middle text-warning me-2"></i>
                                                            Project B</a></td>
                                                    <td>10-10-2021</td>
                                                    <td>72 KB</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="mdi mdi-image font-size-20 align-middle text-success me-2"></i>
                                                            Img-2.png</a></td>
                                                    <td>09-10-2021</td>
                                                    <td>31 KB</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-dark fw-medium"><i
                                                                class="bx bxs-file font-size-20 align-middle text-primary me-2"></i>
                                                            starter-page</a></td>
                                                    <td>08-10-2021</td>
                                                    <td>11 KB</td>
                                                    <td>
    ...
    @section('scripts')
        ...
        <!-- dropzone plugin -->
        <script src="{{ URL::asset('vendors/libs/dropzone/min/dropzone.min.js') }}"></script>

        <!-- file-manager js -->
        <script src="{{ URL::asset('vendors/js/pages/file-manager.init.js') }}"></script>
        <!-- App js -->
