...
@section('body')
                            ...
                            <div class="col-xl-4 col-7">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 avatar me-3 d-sm-block d-none">
                                        <img src="{{ URL::asset('vendors/images/users/avatar-6.jpg') }}" alt=""
                                                        ...
                                                        <ul class="list-inline message-img mt-2 mb-0">
                                                            <li class="list-inline-item message-img-list">
                                                                <a class="d-inline-block" href="">
                                                                    <img src="{{ URL::asset('vendors/images/small/img-1.jpg') }}"
                                                            ...
                                                            <li class="list-inline-item message-img-list">
                                                                <a class="d-inline-block" href="">
                                                                    <img src="{{ URL::asset('vendors/images/small/img-2.jpg') }}"
                                                                        alt="" class="rounded img-thumbnail">
                                                                </a>
                                                            </li>
                                                        </ul>
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('vendors/js/pages/dashboard-sales.init.js') }}"></script>
