...
@section('css')
    ...
    <!-- flatpickr css -->
    <link href="{{ URL::asset('vendors/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css">
@endsection
@section('page-title')
    Invoice List
@endsection
@section('body')
    ...
    @section('scripts')
        ...
        <!-- invoice-list init -->
        <script src="{{ URL::asset('vendors/js/pages/invoice-list.init.js') }}"></script>
        <!-- App js -->
