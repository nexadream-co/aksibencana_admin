...
@section('body')
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="user-profile-img">
                            <img src="{{ URL::asset('vendors/images/pattern-bg.jpg') }}"
                        ...
                        <div class="p-4 pt-0">
                            ...
                            <div class="mt-n5 position-relative text-center border-bottom pb-3">
                                <img src="{{ URL::asset('vendors/images/users/avatar-3.jpg') }}" alt=""
                                ...
                                <div class="mx-n3 px-3" data-simplebar style="max-height: 580px;">
                                    <div class="blog-post">
                                        ...
                                        <div class="position-relative mt-3">
                                            <img src="{{ URL::asset('vendors/images/post-1.jpg') }}" alt=""
                                                class="img-thumbnail">
                                        </div>
                                        <div class="pt-3">
                                            <div
                                    ...
                                    <div class="blog-post mt-3">
                                        ...
                                        <div class="position-relative mt-3">
                                            <img src="{{ URL::asset('vendors/images/post-2.jpg') }}" alt=""
                                                class="img-thumbnail">
                                        </div>
                                        <div class="pt-3">
                                            <div
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('vendors/js/pages/profile.init.js') }}"></script>
        <!-- App js -->
