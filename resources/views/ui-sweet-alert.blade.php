...
@section('css')
    <!-- Sweet Alert-->
    <link href="{{ URL::asset('vendors/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Sweet-Alert
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- Sweet Alerts js -->
        <script src="{{ URL::asset('vendors/libs/sweetalert2/sweetalert2.min.js') }}"></script>

        <!-- Sweet alert init js-->
        <script src="{{ URL::asset('vendors/js/pages/sweet-alerts.init.js') }}"></script>
        <!-- App js -->
