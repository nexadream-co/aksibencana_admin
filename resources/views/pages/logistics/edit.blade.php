                                ...
                                <form method="post" action="{{ route('logistic_update', $logistic->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('district_id') is-invalid @enderror"
                                            ...
                                            @if (@$logistic->expedition->district->id)
                                                <option value="{{ @$logistic->expedition->district->id }}" selected>
                                                    {{ @$logistic->expedition->district->name }},
                                                    {{ @$logistic->expedition->district->city->name }},
                                                    {{ @$logistic->expedition->district->city->province->name }}
                                                </option>
                                            @endif
                                        </select>
                                        @error('district_id')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" rows="3"
                                            placeholder="Addres">{{ old('address') ?? @$logistic->expedition->origin_address }}</textarea>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('receipt_code') ?? @$logistic->expedition->receipt_code }}">
                                        @error('receipt_code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
