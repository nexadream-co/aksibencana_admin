                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mt-4 mt-xl-0">
                                <form method="post" action="{{ route('donation_store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="3"
                                            placeholder="Addres">{{ old('description') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                        <input type="checkbox" class="form-check-input" id="status_active" value="active"
                                            name="status" @if (old('status') == 'active') checked @endif>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('fundraiser_description') is-invalid @enderror" name="fundraiser_description" id="fundraiser_description" rows="3"
                                            placeholder="Fundraiser Description">{{ old('fundraiser_description') }}</textarea>
