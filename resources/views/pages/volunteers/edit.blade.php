                                ...
                                <form method="post" action="{{ route('volunteer_update', $volunteer->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="status_active" class="form-control @error('status') is-invalid @enderror">
                                            ...
                                            <option value="active" @if((old('status') ?? @$volunteer->status) == 'active') selected @endif>Active</option>
                                            <option value="requested" @if((old('status') ?? @$volunteer->status) == 'requested') selected @endif>Requested</option>
                                            <option value="rejected" @if((old('status') ?? @$volunteer->status) == 'rejected') selected @endif>Rejected</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
