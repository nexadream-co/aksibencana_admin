                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mt-4 mt-xl-0">
                                <form method="post" action="{{ route('delivery_update', $delivery->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('disaster_id') is-invalid @enderror"
                                            ...
                                            @if (@$delivery->disaster->id)
                                                <option value="{{ @$delivery->disaster->id }}" selected>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('disaster_station_id') is-invalid @enderror"
                                            ...
                                            @if (@$delivery->station->id)
                                                <option value="{{ @$delivery->station->id }}" selected>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('user_id') is-invalid @enderror" name="user_id"
                                            ...
                                            @if (@$delivery->courier->id)
                                                <option value="{{ @$delivery->courier->id }}" selected>
                                        ...
                                        <select name="branch_office_id" id="branch_office_id"
                                            ...
                                            @foreach ($branch_offices ?? [] as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ((old('branch_office_id') ?? @$delivery->branch_office_id) == $item->id) selected @endif>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="status_active"
                                            ...
                                            <option value="active" @if ((old('status') ?? @$delivery->status) == 'active') selected @endif>Active
                                            </option>
                                            <option value="finished" @if ((old('status') ?? @$delivery->status) == 'finished') selected @endif>
                                                Finished</option>
                                            <option value="canceled" @if ((old('status') ?? @$delivery->status) == 'canceled') selected @endif>
                                                Canceled</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('arrived_at') ?? @$delivery->arrived_at }}">
                                        @error('arrived_at')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
