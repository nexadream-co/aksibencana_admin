                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0 table-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('vendors/images/product/img-2.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail"
                                                        class="text-dark">Sofa Home
                                                        Chair Black</a></h5>
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('vendors/images/product/img-5.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail"
                                                        class="text-dark">Tuition
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('vendors/images/product/img-7.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail"
                                                        class="text-dark">Dining
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('vendors/images/product/img-8.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail"
                                                        class="text-dark">Home &
