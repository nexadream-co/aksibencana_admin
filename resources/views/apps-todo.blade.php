...
@section('body')
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-1">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('vendors/images/users/avatar-1.jpg') }}"
                                                class="rounded-circle avatar-sm" alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('vendors/images/users/avatar-4.jpg') }}"
                                                class="rounded-circle avatar-sm" alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
    ...
    @section('scripts')
        ...
        <!--  -->
        <script src="{{ URL::asset('vendors/js/pages/todo.init.js') }}"></script>
        <!-- App js -->
