...
@section('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('vendors/libs/nouislider/nouislider.min.css') }}">
@endsection
@section('page-title')
    Products
@endsection
@section('body')
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box rounded p-3 mt-4">
                                                ...
                                                <div class="product-img bg-light p-3 rounded">
                                                    <img src="{{ URL::asset('vendors/images/product/img-7.png') }}"
                                                        alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="product-content pt-3">
                                                    <p class="text-muted font-size-13 mb-0">Chair</p>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box rounded p-3 mt-4">
                                                ...
                                                <div class="product-img bg-light p-3 rounded">
                                                    <img src="{{ URL::asset('vendors/images/product/img-9.png') }}"
                                                        alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="product-content pt-3">
                                                    <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
    ...
    @section('scripts')
        ...
        <!-- nouisliderribute js -->
        <script src="{{ URL::asset('vendors/libs/nouislider/nouislider.min.js') }}"></script>
        <script src="{{ URL::asset('vendors/libs/wnumb/wNumb.min.js') }}"></script>

        <!-- init js -->
        <script src="{{ URL::asset('vendors/js/pages/product-filter-range.init.js') }}"></script>
        <!-- App js -->
