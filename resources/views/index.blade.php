                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="popular-product-img p-2">
                                            <img src="{{ URL::asset('vendors/images/product/img.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('vendors/images/product/img-1.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('vendors/images/product/img-8.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('vendors/images/product/img-3.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        class="product-img avatar-title img-thumbnail bg-soft-success border-0">
                                                        <img src="{{ URL::asset('vendors/images/product/img-4.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        class="product-img avatar-title img-thumbnail bg-soft-danger border-0">
                                                        <img src="{{ URL::asset('vendors/images/product/img-5.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('vendors/images/flags/us.jpg') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('vendors/images/flags/italy.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('vendors/images/flags/spain.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('vendors/images/flags/french.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <tbody>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-1.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Neal Matthews
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-2.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Connie Franco
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-3.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Adella Perez
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-4.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Theresa Mayers
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-5.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Oliver Gonzales
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('vendors/images/users/avatar-6.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Willie Verner
                                                    </div>
