...
@section('css')
    <!-- fullcalendar css -->
    <link href="{{ URL::asset('vendors/libs/fullcalendar/main.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Calendar
@endsection
@section('body')
                        ...
                        <div class="card card-h-100">
                            <div class="card-body">
                                ...
                                <div class="row justify-content-center mt-5">
                                    <img src="{{ URL::asset('vendors/images/calendar-img.png') }}" alt=""
    ...
    @section('scripts')
        <!-- plugin js -->
        <script src="{{ URL::asset('vendors/libs/fullcalendar/main.min.js') }}"></script>

        <!-- Calendar init -->
        <script src="{{ URL::asset('vendors/js/pages/calendar.init.js') }}"></script>
        <!-- App js -->
